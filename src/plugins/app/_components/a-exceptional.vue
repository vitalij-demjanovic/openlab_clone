<template>
  <div class="container pd-wrapper-border">
    ...
    <div class="d-flex flex-wrap card-exceptional">
      <div class="card-exceptional-item col-4">
        <img class="mb-3" src="../_components/_icons/exceptional/special1.svg" alt="special">
        <h5 class="fw-bold mb-3">Partnerstvo</h5>
      ...
      <div class="card-exceptional-item col-4">
        <img class="mb-3"  src="../_components/_icons/exceptional/special2.svg" alt="special">
        <h5 class="fw-bold mb-3">LabMaster</h5>
      ...
      <div  class="card-exceptional-item col-4">
        <img class="mb-3"  src="../_components/_icons/exceptional/special3.svg" alt="special">
        <h5 class="fw-bold mb-3">Učebný blok</h5>
      ...
      <div class="card-exceptional-item col-4">
        <img class="mb-3"  src="../_components/_icons/exceptional/special4.svg" alt="special">
        <h5 class="fw-bold mb-3">Problem driven</h5>
      ...
      <div class="card-exceptional-item col-4">
        <img class="mb-3"  src="../_components/_icons/exceptional/special5.svg" alt="special">
        <h5 class="fw-bold mb-3">Project driven</h5>
      ...
      <div class="card-exceptional-item col-4">
        <img class="mb-3"  src="../_components/_icons/exceptional/special6.svg" alt="special">
        <h5 class="fw-bold mb-3">Samoštúdium</h5>
