<template>
  <div>
    ...
    <b-row>
      ...
      <b-col class="col-4">
        <img src="../_icons/special5.svg" alt="special">
      ...
      <b-col class="col-4">
        <img src="../_icons/special6.svg" alt="special">
        <h5>Samoštúdium</h5>
