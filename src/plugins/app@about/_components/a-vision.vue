<template>
  <div class="container">
    <b-row class="align-items-center">
      <b-col class="mb-5 mb-md-0-4 col-md-6 col-12">
        <h1 class="mb-5">
          Naša vízia
      ...
      <b-col class="col-md-6 col-12 d-flex flex-wrap justify-content-center justify-content-lg-end px-1 px-md-2 gap-3">
